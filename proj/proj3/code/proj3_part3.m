...
%[~, matched_a, matched_b] = ransac_fundamental_matrix(Points_2D_pic_a, Points_2D_pic_b);
%[F_matrix, matched_a, matched_b] = ransac_fundamental_matrix(matched_a(:,1:2), matched_b(:,1:2));
