...
%this parameter.
image1 = imresize(image1, scale_factor_1, 'bilinear');
image2 = imresize(image2, scale_factor_2, 'bilinear');
...
[keypoints1, DGS1] = get_interest_points(image1_bw);
visualizeKeypoints(image1_bw, keypoints1, 'image1_keypoints.jpg');
[keypoints2, DGS2] = get_interest_points(image2_bw);
visualizeKeypoints(image2_bw, keypoints2, 'image2_keypoints.jpg');
...
keypoints1 = get_features(keypoints1, DGS1);
keypoints2 = get_features(keypoints2, DGS2);
x1=[keypoints1.x_abs]';
y1=[keypoints1.y_abs]';
x2=[keypoints2.x_abs]';
y2=[keypoints2.y_abs]';
...
evaluate_correspondence(image1, image2, eval_file, ...
