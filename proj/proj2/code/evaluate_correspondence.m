...
% you want to.
function evaluate_correspondence(imgA, imgB, ground_truth_correspondence_file, scale_factor_1, scale_factor_2, x1_est, y1_est, x2_est, y2_est)
...
x1_est = x1_est ./ scale_factor_1;
y1_est = y1_est ./ scale_factor_1;
x2_est = x2_est ./ scale_factor_2;
y2_est = y2_est ./ scale_factor_2;
...
for i = 1:length(x1_est)
    ...
    plot(x1_est(i)*scale_factor_1,y1_est(i)*scale_factor_1, 'o', 'LineWidth',2, 'MarkerEdgeColor',edgeColor,...
                       'MarkerFaceColor', cur_color, 'MarkerSize',10)

    plot(x2_est(i)*scale_factor_2+shiftX,y2_est(i)*scale_factor_2, 'o', 'LineWidth',2, 'MarkerEdgeColor',edgeColor,...
                       'MarkerFaceColor', cur_color, 'MarkerSize',10)
end
hold off;
